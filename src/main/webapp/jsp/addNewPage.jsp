...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form class="col-lg-10" id="addPageForm" role="form" method="POST" action="addPage">
                <div class="form-group row col-lg-12">
                    <label for="heading">Page Heading:</label>
                    <input class="form-control" type="text" name="heading" id="heading" placeholder="Page heading" required/>
                </div>
                <div class="form-group row col-lg-12">
                    <label for="textarea">Body: </label>
                    <textarea form="addPageForm" class="form-control" id="textarea" name="textarea" type="text"></textarea>
                </div>
                <br/>
